...
class Transformer(nn.Module):
    def __init__(self, pad_idx, vocab_size, max_len, n_layers, d_model, d_ff, n_heads, drop_p):
        super().__init__()
    ...
    def make_dec_mask(self, trg):
        ...
        trg_future_mask = trg_future_mask.to(self.device) # pad_mask | future_mask 할 때 같은 DEVICE 여야
        """ trg future mask
        F T T T T
        F F T T T
        F F F T T
